#!/usr/bin/env python3
"""
Sentinel — Build 42: AI v3.0 user promptit (fixed v3)
"""
...
def patch():
    ...
    backup = FILE + '.backup_ai_v3_user2'
    ...
    if old1 in content:
        ...
        print("❌ analyzeResults user prompt — ei löydy")
    ...
    if old2 in content:
        ...
        print("❌ generateRiskProfile user prompt — ei löydy")
    ...
    if old3 in content:
        ...
        print("❌ detectContradictions user prompt — ei löydy")
